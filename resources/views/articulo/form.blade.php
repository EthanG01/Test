    ...
    <div class="box-body">
        ...
        <div class="form-group">
           ...
           <div class="form-group">
            ...
            {{ Form::select('dimension_id',$dimensions, $articulo->dimension_id, ['class' => 'form-control' . ($errors->has('dimension_id') ? ' is-invalid' : ''), 'placeholder' => '']) }}
            {!! $errors->first('dimension_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('variable') }}
            {{ Form::select('variable_id',$variables, $articulo->variable_id, ['class' => 'form-control' . ($errors->has('variable_id') ? ' is-invalid' : ''), 'placeholder' => '']) }}
