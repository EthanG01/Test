...
class ProyectoController extends Controller
{
    ...
    {
         $this->middleware('permission:ver-proyecto|crear-proyecto|editar-proyecto|borrar-proyecto|permission:habilitar-proyecto')->only('index');
    ...
    public function estado($id)
    {
        ...
        ->with('success', 'Estado del Proyectos actualizado correctamente');
    }
