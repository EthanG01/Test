...
class InvolucradoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $involucrados=Involucrado::where('nombrePersona','like','%'.$buscarpor.'%')->paginate($this::PAGINACION);
    ...
    public function pdf()
    {
        ...
        return $pdf->setPaper('a4', 'landscape')->download('involucrado.pdf');
    ...
    public function create()
    {
        ...
        return view('involucrado.create', compact('involucrado','Organizacions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('involucrado.edit', compact('involucrado','Organizacions'));
    }
