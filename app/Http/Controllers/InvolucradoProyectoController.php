...
class InvolucradoProyectoController extends Controller
{
    ...
    public function create()
    {
        ...
        $involucrados = Involucrado::pluck('nombrePersona','id');
      
        return view('involucrado-proyecto.create', compact('involucradoProyecto','proyectos','involucrados'));
    }
    ...
    public function edit($id)
    {
        ...
        $proyectos = Proyecto::pluck('nombreProyecto','id');
        $involucrados = Involucrado::pluck('nombrePersona','id');
        return view('involucrado-proyecto.edit', compact('involucradoProyecto','proyectos','involucrados'));
    }
